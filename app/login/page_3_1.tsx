    ...
    <main className="flex-1 p-5 space-y-4">
      ...
      <div>
        ...
        <div className="input-gold flex items-center gap-2 mt-1">
          ...
          <input className="flex-1 outline-none font-bold text-blue-900" defaultValue="98765 43210" inputMode="numeric" />
        </div>
      </div>
      ...
      <button onClick={() => router.push("/home")} className="gold-btn w-full text-white text-lg font-bold py-3 rounded-2xl">
        Login Karo
      </button>

      <p className="text-center text-gray-400 text-sm">ya</p>

      <button onClick={() => router.push("/home")} className="w-full bg-white border-2 border-gray-200 rounded-2xl py-3 font-bold text-blue-900 flex items-center justify-center gap-2">
