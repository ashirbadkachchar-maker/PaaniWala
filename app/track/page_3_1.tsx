      ...
      <main className="flex-1 p-4 space-y-4">
        ...
        <div className="gold-card rounded-2xl p-4 text-sm space-y-1">
          <div className="flex justify-between items-center">
            <span className="font-bold text-blue-900">Order ID: PW-4821</span>
            <span className="bg-green-100 text-green-700 text-xs font-bold px-3 py-1 rounded-full">Raste Me Hai</span>
          </div>
          <p>2 Camper - 20L</p>
          <p className="text-gray-500">Aaj Subah 8 Baje</p>
        </div>
