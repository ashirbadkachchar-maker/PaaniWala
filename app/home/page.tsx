  ...
  return (
    <>
      ...
      <main className="flex-1 p-4 space-y-4">
        ...
        <Link href="/sellers" className="gold-card rounded-2xl p-4 text-center block">
          <div className="text-5xl">🏪</div>
          <p className="font-bold text-blue-900 mt-2 text-lg">Sellers Dekho</p>
          <p className="text-sm text-gray-500">Apne area ke sellers se order karo</p>
        </Link>
